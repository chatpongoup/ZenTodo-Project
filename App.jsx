        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
          <div className="flex items-center gap-6">
            <div className="space-y-1">
              <h1 className={`text-4xl md:text-5xl font-black tracking-tighter ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>ZenTodo</h1>
              <p className="text-blue-500 font-black uppercase tracking-[0.4em] text-[10px]">Strategic Command</p>
            </div>
            <div className="h-10 w-[2px] bg-white/10 hidden md:block"></div>
            <div className="hidden md:block">
              <p className="text-[10px] font-black uppercase tracking-widest text-white/30 mb-1">Current Sector Time</p>
              <p className="text-xl font-black tracking-tight text-white/80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <main className="md:col-span-8 space-y-4">
            <div className="flex justify-between items-center px-2">
              <span className="text-sm font-medium text-white/50">{filteredTasks.length} Tasks</span>
              <div className="flex items-center gap-2 text-sm">
                <span className="text-white/40">Sort by:</span>
                <select 
                  className="bg-transparent text-white border-0 cursor-pointer focus:ring-0"
                  value={sortBy}
