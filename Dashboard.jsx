...
const Dashboard = ({ tasks }) => {
  ...
  const stats = [
    { label: 'Total Tasks', value: total, icon: ListTodo, color: 'text-blue-400' },
    { label: 'Completed', value: completed, icon: CheckCircle, color: 'text-emerald-400' },
    { label: 'Efficiency', value: `${percentage}%`, icon: TrendingUp, color: 'text-purple-400' },
  ];
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="md:col-span-2 glass-card flex items-center justify-between overflow-hidden relative">
        <div className="relative z-10">
          <h2 className="text-xl font-bold text-white mb-2">Daily Progress</h2>
      ...
      <div className="glass-card flex flex-col justify-between">
        ...
        <div className="mt-4 pt-4 border-t border-white/5">
          <div className="flex justify-between items-center px-1">
            <span className="text-[10px] uppercase font-bold text-white/30 tracking-wider">Goal</span>
